package br.com.lucasfogaca.appreceita;
...
/**
 * Created by lucasfogaca on 16/11/15.
 */
public class ReceitaAdapter extends ArrayAdapter <Receita> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View linha = LayoutInflater.from(getContext()).inflate(R.layout.receita_adapter, null);
